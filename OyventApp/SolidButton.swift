...
//  OyventApp
//
//  Created by Mehmet Sen on 6/26/15.
...
//        backgroundColor = UIColor(red: 0x04/255, green: 0x7f/255, blue: 0xb7/255, alpha: 1.0)
    ...
    func updateLayerProperties() {
        ...
        if let superview = superview {
            ...
            //superview.backgroundColor = UIColor(red: 0xff/255, green: 0xff/255, blue: 0xff/255, alpha: 1.0)//ffffff
...
//            superview.layer.cornerRadius = 12.0
//            superview.layer.borderWidth = 1.0
//            superview.layer.borderColor = UIColor(red: 0xcc/255, green: 0xcc/255, blue: 0xcc/255, alpha: 1.0).CGColor
