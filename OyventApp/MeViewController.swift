...
class MeViewController: UIViewController, ProfileAPIControllerProtocol, CLLocationManagerDelegate, ENSideMenuDelegate {

    var userApi:ProfileAPIController?
    private let concurrentProfileQueue = dispatch_queue_create(
        "com.oy.vent.mQueue", DISPATCH_QUEUE_CONCURRENT)
    //location
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        userApi?.searchProfile(pkUserID)
