...
class PhotoAPIController{
    ...
    func searchPhotos(pageNo: Int, latitude: String, longitude: String, albumID: Int) {
        let urlPath = "http://oyvent.com/ajax/Feeds.php?"
        post(urlPath, currentPage: pageNo, latitude: latitude, longitude: longitude, albumID: albumID)
    }
    
    
    func post(path: String, currentPage: Int, latitude: String, longitude: String, albumID: Int) {
